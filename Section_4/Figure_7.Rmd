...
```{python}
deltas = np.array([0,.015,.03,.045])

Planks = np.zeros((302,len(deltas)))
Chems = np.zeros((302,len(deltas)))
for k in range(len(deltas)):
    ...
    TotalTime = int(150/Swimmers.dt) #Total number of iterations for the experiment
...
This plots the steady state plankton density by centering the data around the largest point of the aggregation. 
